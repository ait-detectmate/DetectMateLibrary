...
NAMED_TEMPLATES_TXT = "src/detectmatelibrary/testutils/data/test_named_templates.txt"
NAMED_TEMPLATES_CSV = "src/detectmatelibrary/testutils/data/test_named_templates.csv"

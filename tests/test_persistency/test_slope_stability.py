...
class TestConfigWiring:
    def test_block_reaches_per_variable_trackers(self):
        ...
        assert default.persistency.event_struct.event_data_kwargs.get("classification") is None
        ...
        block = rebuilt.auto_conf_persistency.event_struct.event_data_kwargs["classification"]
    ...
    def test_default_block_is_not_forwarded(self):
        ...
        it."""
        default = CharsetDetector(config=CharsetDetectorConfig())
        assert "classification" not in (default.auto_conf_persistency.event_struct.event_data_kwargs or {})
    ...
    def test_index_axis_methods_pull_in_no_timestamp_requirement(self):
        ...
        assert "classification" not in (rebuilt.persistency.event_struct.event_data_kwargs or {})
...
def test_slope_threshold_reaches_the_classifier():
    ...
    tracker = persistency.event_struct.event_data_class(**persistency.event_struct.event_data_kwargs)

...
from tests.test_detectors.dummy_detector import DummyDetector, DummyDetectorConfig
from tests.test_parsers.dummy_parser import DummyParser, DummyParserConfig

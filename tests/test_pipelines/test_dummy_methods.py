...
from detectmatelibrary._testutils.dummy_detector import DummyDetector, DummyDetectorConfig
from detectmatelibrary._testutils.dummy_parser import DummyParser, DummyParserConfig

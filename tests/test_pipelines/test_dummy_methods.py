...
from detectmatelibrary.testutils.dummy_detector import DummyDetector, DummyDetectorConfig
from detectmatelibrary.testutils.dummy_parser import DummyParser, DummyParserConfig
